...
|                 | Qualification              | Quantification |
| --------------- | -------------------------- | -------------- |
| #1 SDLC         | Améliorer le SDLC          | 7              |
| #2 Performance  | Mesurer la performance     | 2              |
| #3 Sécurité     | Prioriser la sécurité      | 5              |
| #4 Résilience   | Assurer la résilience      | 8              |
| #5 Compétence   | Monter en compétences      | 9              |
| #6 Doc          | Contrôler la documentation | 7              |
| #7 Inefficacité | Réduire les inefficacités  | 4              |
| #8 FinOps       | Maîtriser les coûts        | 3              |
